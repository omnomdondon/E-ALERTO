...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _fetchUserProfileAndReports() async {
    ...
    // Ensure BASE_URL is correctly set in .env file
    ...
    final profileRes = await http.get(
      Uri.parse(
          '$baseUrl/profile'), // Make sure to use the full URL including the base URL
    ...
    final reportsRes = await http.get(
      Uri.parse(
          '$baseUrl/reports'), // Also make sure this URL is correctly formed
      headers: {'Authorization': 'Bearer $token'},
    );
