...
//         defaultValue: 'http://192.168.100.121:3000/api');
...
//   Future<void> _onRefresh() async {
//     await _fetchUserProfileAndReports(); // Fetch data again when user swipes down
//   }
...
//           length: 3,
//           child: RefreshIndicator(
//             onRefresh: _onRefresh, // Triggered on swipe-down refresh
//             child: NestedScrollView(
//               headerSliverBuilder: (context, innerBoxIsScrolled) => [
//                 SliverToBoxAdapter(
//                   child: Padding(
...
//         // Ensure that reports are filtered based on the logged-in user's username
